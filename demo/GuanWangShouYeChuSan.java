 ...
 */
public class GuanWangShouYeChuSan {
    private static Log logger = LogFactory.getLog(GuanWangShouYeChuSan.class); //打印日志
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            logger.error("官网首页初三getFreeLesson出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            logger.error("官网首页初三getFreeLesson1出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            logger.error("官网首页初三getFreeLesson2出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            logger.error("官网首页初三getFreeLesson3出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            logger.error("官网首页初三getFreeLesson4出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        driver.quit();
    }
    private static void getFreeLesson(WebDriver driver,String mobile) throws InterruptedException {
        ...
        Thread.sleep(2000);
        By by = By.xpath("//*[@id=\"lessonSystem\"]/div/ul[1]/li[3]/a");  //然后才能点击
        ...
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("官网首页初三课程，第1个0元试听失败！");
        }else{
            logger.debug("官网首页初三课程，第1个0元试听成功！");
        }
    }
    private static void getFreeLesson1(WebDriver driver,String mobile) throws InterruptedException {
        ...
        String strUrl2 = "https://v2-test.zm1v1.com/appointment-success";
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("官网首页初三课程，第2个0元试听失败！");
        }else{
            logger.debug("官网首页初三课程，第2个0元试听成功！");
        }
    }
    private static void getFreeLesson2(WebDriver driver,String mobile) throws InterruptedException {
        ...
        String strUrl2 = "https://v2-test.zm1v1.com/appointment-success";
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("官网首页初三课程，第3个0元试听失败！");
        }else{
            logger.debug("官网首页初三课程，第3个0元试听成功！");
        }
    }
    private static void getFreeLesson3(WebDriver driver,String mobile) throws InterruptedException {
        ...
        String strUrl2 = "https://v2-test.zm1v1.com/appointment-success";
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("官网首页初三课程，第4个0元试听失败！");
        }else{
            logger.debug("官网首页初三课程，第4个0元试听成功！");
        }
    }
    private static void getFreeLesson4(WebDriver driver,String mobile) throws InterruptedException {
        ...
        Thread.sleep(3000);
        String strUrl = "https://v2-test.zm1v1.com/zm-lessons/chusan-shuxue.html";
        if(strUrl.equals(driver.getCurrentUrl())){
            logger.debug("点击初三数学，跳转正确");
        }else{
            logger.debug("点击初三数学，跳转错误");
        }
        Thread.sleep(2000);
        ...
        Thread.sleep(2000);
        String strUrl1 = "https://v2-test.zm1v1.com/zm-lessons/chusan-yingyu.html";
        if(strUrl1.equals(driver.getCurrentUrl())){
            logger.debug("点击初三英语，跳转正确");
        }else{
            logger.debug("点击初三英语，跳转错误");
        }
        Thread.sleep(2000);
        driver.navigate().back();
        Thread.sleep(1000);
        ...
        Thread.sleep(3000);
        String strUrl2 = "https://v2-test.zm1v1.com/zm-lessons/chusan-yuwen.html";
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("点击初三语文，跳转正确");
        }else{
            logger.debug("点击初三语文，跳转错误");
        }
        Thread.sleep(2000);
        driver.navigate().back();
        Thread.sleep(1000);
        ...
        Thread.sleep(2000);
        String strUrl3 = "https://v2-test.zm1v1.com/zm-lessons/chusan-wuli.html";
        if(strUrl3.equals(driver.getCurrentUrl())){
            logger.debug("点击初三物理，跳转正确");
        }else{
            logger.debug("点击初三物理，跳转错误");
        }
        Thread.sleep(2000);
        driver.navigate().back();
        Thread.sleep(1000);
        ...
        Thread.sleep(2000);
        String strUrl6 = "https://v2-test.zm1v1.com/zm-lessons/chusan-huaxue.html";
        if(strUrl6.equals(driver.getCurrentUrl())){
            logger.debug("点击初三化学，跳转正确");
        }else{
            logger.debug("点击初三化学，跳转错误");
        }
    }
}
