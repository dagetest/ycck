 ...
 */
public class GuanWangShouYeChuSanShuXue {
    private static Log logger = LogFactory.getLog(GuanWangShouYeChuSanShuXue.class); //打印日志
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            logger.error("官网首页初三数学getFreeLesson出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            logger.error("官网首页初三数学getFreeLesson1出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            logger.error("官网首页初三数学getFreeLesson2出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            logger.error("官网首页初三数学getFreeLesson3出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        driver.quit();
    }
    private static void getFreeLesson(WebDriver driver,String mobile) throws InterruptedException {
        ...
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("官网首页初三数学课程，第1个0元试听失败！");
        }else{
            logger.debug("官网首页初三数学课程，第1个0元试听成功！");
        }
    }
    private static void getFreeLesson1(WebDriver driver,String mobile) throws InterruptedException {
        ...
        String strUrl2 = "https://v2-test.zm1v1.com/appointment-success";
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("官网首页初三数学课程，第2个0元试听失败！");
        }else{
            logger.debug("官网首页初三数学课程，第2个0元试听成功！");
        }
    }
    private static void getFreeLesson2(WebDriver driver,String mobile) throws InterruptedException {
        ...
        String strUrl2 = "https://v2-test.zm1v1.com/appointment-success";
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("官网首页初三数学课程，第3个0元试听失败！");
        }else{
            logger.debug("官网首页初三数学课程，第3个0元试听成功！");
        }
    }
    private static void getFreeLesson3(WebDriver driver,String mobile) throws InterruptedException {
        ...
        String strUrl2 = "https://v2-test.zm1v1.com/appointment-success";
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("官网首页初三数学课程，第4个0元试听失败！");
        }else{
            logger.debug("官网首页初三数学课程，第4个0元试听成功！");
        }
    }
}
