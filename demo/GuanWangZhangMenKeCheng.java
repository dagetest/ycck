 ...
 */
public class GuanWangZhangMenKeCheng {
    private static Log logger = LogFactory.getLog(GuanWangZhangMenKeCheng.class); //打印日志
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            logger.error("官网掌门课程getFreeLesson1 出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            logger.error("官网掌门课程getFreeLesson2 出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        driver.quit();
    }
    private static void getFreeLesson(WebDriver driver,String mobile) throws InterruptedException {      // private 私有类
        ...
        //点击掌门课程
        driver.findElement(By.xpath("//*[@id=\"n-nav-area\"]/a[3]")).click();
        Thread.sleep(5000);
        //点击免费试听
        ...
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("官网掌门课程，第1个0元试听失败！");
        }else{
            logger.debug("官网掌门课程，第1个0元试听成功！");
        }
    }
    private static void getFreeLesson1(WebDriver driver,String mobile) throws InterruptedException {
        ...
        js.executeScript("arguments[0].scrollIntoView()",driver.findElement(By.xpath("//*[@id=\"exClusiveSystem\"]/div"))); //先定位到父级的div
        Thread.sleep(3000);
        By by = By.xpath("//*[@id=\"exClusiveSystem\"]/div/div[2]/div/a");  //然后才能点击
        ...
        String strUrl2 = "https://v2-test.zm1v1.com/appointment-success";
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("官网掌门课程，第2个0元试听失败！");
        }else{
            logger.debug("官网掌门课程，第2个0元试听成功！");
        }
    }
    private static void getFreeLesson2(WebDriver driver,String mobile) throws InterruptedException {
        ...
        String strUrl2 = "https://v2-test.zm1v1.com/appointment-success";
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("官网掌门课程，第3个0元试听失败！");
        }else{
            logger.debug("官网掌门课程，第3个0元试听成功！");
        }
    }
}
