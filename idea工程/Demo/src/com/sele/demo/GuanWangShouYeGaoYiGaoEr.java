 ...
 */
public class GuanWangShouYeGaoYiGaoEr {
    private static Log logger = LogFactory.getLog(GuanWangShouYeGaoYiGaoEr.class); //打印日志
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            logger.error("官网首页高一高二getFreeLesson 出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            logger.error("官网首页高一高二getFreeLesson1 出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            logger.error("官网首页高一高二getFreeLesson2 出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            logger.error("官网首页高一高二getFreeLesson3 出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            logger.error("官网首页高一高二getFreeLesson4 出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        driver.quit();
    }
    private static void getFreeLesson(WebDriver driver,String mobile) throws InterruptedException {
        ...
        Thread.sleep(2000);
        By by = By.xpath("//*[@id=\"lessonSystem\"]/div/ul[1]/li[4]/a");  //然后才能点击
        ...
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("官网首页高一高二课程，第1个0元试听失败！");
        }else{
            logger.debug("官网首页高一高二课程，第1个0元试听成功！");
        }
    }
    private static void getFreeLesson1(WebDriver driver,String mobile) throws InterruptedException {
        ...
        String strUrl2 = "https://v2-test.zm1v1.com/appointment-success";
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("官网首页高一高二课程，第2个0元试听失败！");
        }else{
            logger.debug("官网首页高一高二课程，第2个0元试听成功！");
        }
    }
    private static void getFreeLesson2(WebDriver driver,String mobile) throws InterruptedException {
        ...
        String strUrl2 = "https://v2-test.zm1v1.com/appointment-success";
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("官网首页高一高二课程，第3个0元试听失败！");
        }else{
            logger.debug("官网首页高一高二课程，第3个0元试听成功！");
        }
    }
    private static void getFreeLesson3(WebDriver driver,String mobile) throws InterruptedException {
        ...
        String strUrl2 = "https://v2-test.zm1v1.com/appointment-success";
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("官网首页高一高二课程，第4个0元试听失败！");
        }else{
            logger.debug("官网首页高一高二课程，第4个0元试听成功！");
        }
    }
    private static void getFreeLesson4(WebDriver driver,String mobile) throws InterruptedException {
        ...
        Thread.sleep(3000);
        String strUrl = "https://v2-test.zm1v1.com/zm-lessons/gaoyi_gaoer-shuxue.html";
        if(strUrl.equals(driver.getCurrentUrl())){
            logger.debug("点击高一高二数学，跳转正确");
        }else{
            logger.debug("点击高一高二数学，跳转错误");
        }
        Thread.sleep(2000);
        ...
        Thread.sleep(2000);
        String strUrl1 = "https://v2-test.zm1v1.com/zm-lessons/gaoyi_gaoer-yingyu.html";
        if(strUrl1.equals(driver.getCurrentUrl())){
            logger.debug("点击高一高二英语，跳转正确");
        }else{
            logger.debug("点击高一高二英语，跳转错误");
        }
        Thread.sleep(2000);
        driver.navigate().back();
        Thread.sleep(1000);
        ...
        Thread.sleep(3000);
        String strUrl2 = "https://v2-test.zm1v1.com/zm-lessons/gaoyi_gaoer-yuwen.html";
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("点击高一高二语文，跳转正确");
        }else{
            logger.debug("点击高一高二语文，跳转错误");
        }
        Thread.sleep(2000);
        driver.navigate().back();
        Thread.sleep(1000);
        ...
        Thread.sleep(2000);
        String strUrl3 = "https://v2-test.zm1v1.com/zm-lessons/gaoyi_gaoer-wuli.html";
        if(strUrl3.equals(driver.getCurrentUrl())){
            logger.debug("点击高一高二物理，跳转正确");
        }else{
            logger.debug("点击高一高二物理，跳转错误");
        }
        Thread.sleep(2000);
        driver.navigate().back();
        Thread.sleep(1000);
        ...
        Thread.sleep(2000);
        String strUrl6 = "https://v2-test.zm1v1.com/zm-lessons/gaoyi_gaoer-huaxue.html";
        if(strUrl6.equals(driver.getCurrentUrl())){
            logger.debug("点击高一高二化学，跳转正确");
        }else{
            logger.debug("点击高一高二化学，跳转错误");
        }
        Thread.sleep(2000);
        driver.navigate().back();
        Thread.sleep(1000);
        ...
        Thread.sleep(2000);
        String strUrl7 = "https://v2-test.zm1v1.com/zm-lessons/gaoyi_gaoer-shengwu.html";
        if(strUrl7.equals(driver.getCurrentUrl())){
            logger.debug("点击高一高二生物，跳转正确");
        }else{
            logger.debug("点击高一高二生物，跳转错误");
        }
    }
}
