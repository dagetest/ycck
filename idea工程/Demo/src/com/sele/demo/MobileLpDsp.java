...
public class MobileLpDsp {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // 打开连接
        driver.get("http://v2-test.zm1v1.com/mobile/lp/dsp");
        driver.manage().window().maximize();
        //青少年在线教育，免费试听
        String mobile = "15121212145";
        ...
        try {
            ...
            driver.get("http://v2-test.zm1v1.com/mobile/lp/dsp");
            logger.error("MobileLpDsp页面getFreeLesson 出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            driver.get("http://v2-test.zm1v1.com/mobile/lp/dsp");
            logger.error("MobileLpDsp页面getFreeLesson1 出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            driver.get("http://v2-test.zm1v1.com/mobile/lp/dsp");
            logger.error("MobileLpDsp页面getFreeLesson2 出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            driver.get("http://v2-test.zm1v1.com/mobile/lp/dsp");
            logger.error("MobileLpDsp页面getFreeLesson3 出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            driver.get("http://v2-test.zm1v1.com/mobile/lp/dsp");
            logger.error("MobileLpDsp页面getFreeLesson4 出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            driver.get("http://v2-test.zm1v1.com/mobile/lp/dsp");
            logger.error("MobileLpDsp页面getFreeLesson5 出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        driver.quit();
    }
    ...
    private static void getFreeLesson(WebDriver driver,String mobile) throws InterruptedException {      // private 私有类
        ...
        js.executeScript("arguments[0].scrollIntoView()",driver.findElement(By.xpath("//*[@id=\"mheaderbtn2\"]"))); //先定位到父级的div
        Thread.sleep(2000);
...
//        element.click();
        ...
        js1.executeScript("arguments[0].scrollIntoView()",driver.findElement(By.xpath("//*[@id=\"mheaderbtn2\"]")));
        //点击提交按钮
    ...
    private static void getFreeLesson1(WebDriver driver,String mobile) throws InterruptedException {      // private 私有类
        ...
        js2.executeScript("arguments[0].scrollIntoView()",driver.findElement(By.xpath("//*[@id=\"wrapper\"]/div[3]/div/a/div"))); //先定位到父级的div
        Thread.sleep(1000);
        By by = By.xpath("//*[@id=\"wrapper\"]/div[3]/div/a/div");  //然后才能点击
        WebElement element = driver.findElement(by);
        element.click();
        //填写信息
        driver.findElement(By.xpath("//*[@id=\"name\"]")).sendKeys("自动化测试账号");
    ...
    private static void getFreeLesson2(WebDriver driver,String mobile) throws InterruptedException {      // private 私有类
        //点击第三个预约试听
        JavascriptExecutor js = ((JavascriptExecutor) driver);
        js.executeScript("arguments[0].scrollIntoView()",driver.findElement(By.xpath("//*[@id=\"wrapper\"]/div[4]/div/a/div"))); //先定位到父级的div
        Thread.sleep(2000);
        By by = By.xpath("//*[@id=\"wrapper\"]/div[4]/div/a/div");  //然后才能点击
        WebElement element = driver.findElement(by);
        element.click();
        //填写信息
        driver.findElement(By.xpath("//*[@id=\"name\"]")).sendKeys("自动化测试账号");
    ...
    private static void getFreeLesson3(WebDriver driver,String mobile) throws InterruptedException {      // private 私有类
        ...
        JavascriptExecutor js = ((JavascriptExecutor) driver);
        js.executeScript("arguments[0].scrollIntoView()",driver.findElement(By.xpath("//*[@id=\"wrapper\"]/div[5]/div/a/div"))); //先定位到父级的div
        Thread.sleep(1000);
        By by = By.xpath("//*[@id=\"wrapper\"]/div[5]/div/a/div");  //然后才能点击
        WebElement element = driver.findElement(by);
        element.click();
        //填写信息
        driver.findElement(By.xpath("//*[@id=\"name\"]")).sendKeys("自动化测试账号");
    ...
    private static void getFreeLesson4(WebDriver driver,String mobile) throws InterruptedException {      // private 私有类
        //点击第五个预约试听
        JavascriptExecutor js = ((JavascriptExecutor) driver);
        js.executeScript("arguments[0].scrollIntoView()",driver.findElement(By.xpath("//*[@id=\"wrapper\"]/div[6]/div/a/div"))); //先定位到父级的div
        Thread.sleep(1000);
        By by = By.xpath("//*[@id=\"wrapper\"]/div[6]/div/a/div");  //然后才能点击
        WebElement element = driver.findElement(by);
        element.click();
        //填写信息
        driver.findElement(By.xpath("//*[@id=\"name\"]")).sendKeys("自动化测试账号");
