 ...
 */
public class GuanWangShouYeChuYiChuEr {
    private static Log logger = LogFactory.getLog(GuanWangShouYeChuYiChuEr.class); //打印日志
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            logger.error("官网首页初一初二getFreeLesson出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            logger.error("官网首页初一初二getFreeLesson1 出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            logger.error("官网首页初一初二getFreeLesson2 出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            logger.error("官网首页初一初二getFreeLesson3 出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        try {
            ...
            System.out.println("出异常了 = [" + args + "]");
            logger.error("官网首页初一初二getFreeLesson4 出异常了");
        }
        DBTools4Student.allowDuplicateRegiste(mobile);//清除手机号
        driver.quit();
    }
    private static void getFreeLesson(WebDriver driver,String mobile) throws InterruptedException {
        ...
        Thread.sleep(2000);
        By by = By.xpath("//*[@id=\"lessonSystem\"]/div/ul[1]/li[2]/a");  //然后才能点击
        ...
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("官网首页初一初二课程，第1个0元试听失败！");
        }else{
            logger.debug("官网首页初一初二课程，第1个0元试听成功！");
        }
    }
    private static void getFreeLesson1(WebDriver driver,String mobile) throws InterruptedException {
        ...
        //定位首页，点击初一初二科目
        //*[@id="lessonSystem"]/div/ul[1]/li[2]/a
        JavascriptExecutor js = ((JavascriptExecutor) driver);
        js.executeScript("arguments[0].scrollIntoView()",driver.findElement(By.xpath("//*[@id=\"lessonSystem\"]/div"))); //先定位到父级的div
        Thread.sleep(2000);
        By by = By.xpath("//*[@id=\"lessonSystem\"]/div/ul[1]/li[2]/a");  //然后才能点击
        ...
        String strUrl2 = "https://v2-test.zm1v1.com/appointment-success";
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("官网首页初一初二课程，第2个0元试听失败！");
        }else{
            logger.debug("官网首页初一初二课程，第2个0元试听成功！");
        }
    }
    private static void getFreeLesson2(WebDriver driver,String mobile) throws InterruptedException {
        ...
        String strUrl2 = "https://v2-test.zm1v1.com/appointment-success";
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("官网首页初一初二课程，第3个0元试听失败！");
        }else{
            logger.debug("官网首页初一初二课程，第3个0元试听成功！");
        }
    }
    private static void getFreeLesson3(WebDriver driver,String mobile) throws InterruptedException {
        ...
        String strUrl2 = "https://v2-test.zm1v1.com/appointment-success";
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("官网首页初一初二课程，第4个0元试听失败！");
        }else{
            logger.debug("官网首页初一初二课程，第4个0元试听成功！");
        }
    }
    private static void getFreeLesson4(WebDriver driver,String mobile) throws InterruptedException {
        ...
        Thread.sleep(3000);
        String strUrl = "https://v2-test.zm1v1.com/zm-lessons/chuyi_chuer-shuxue.html";
        if(strUrl.equals(driver.getCurrentUrl())){
            logger.debug("点击初一初二数学，跳转正确");
        }else{
            logger.debug("点击初一初二数学，跳转错误");
        }
        Thread.sleep(2000);
        ...
        Thread.sleep(2000);
        String strUrl1 = "https://v2-test.zm1v1.com/zm-lessons/chuyi_chuer-yingyu.html";
        if(strUrl1.equals(driver.getCurrentUrl())){
            logger.debug("点击初一初二英语，跳转正确");
        }else{
            logger.debug("点击初一初二英语，跳转错误");
        }
        Thread.sleep(2000);
        driver.navigate().back();
        Thread.sleep(1000);
        ...
        Thread.sleep(3000);
        //点击小学语文
        String strUrl2 = "https://v2-test.zm1v1.com/zm-lessons/chuyi_chuer-yuwen.html";
        if(strUrl2.equals(driver.getCurrentUrl())){
            logger.debug("点击初一初二语文，跳转正确");
        }else{
            logger.debug("点击初一初二语文，跳转错误");
        }
        Thread.sleep(2000);
        driver.navigate().back();
        Thread.sleep(1000);
        ...
        Thread.sleep(2000);
        String strUrl3 = "https://v2-test.zm1v1.com/zm-lessons/chuyi_chuer-wuli.html";
        if(strUrl3.equals(driver.getCurrentUrl())){
            logger.debug("点击初一初二物理，跳转正确");
        }else{
            logger.debug("点击初一初二物理，跳转错误");
        }
        Thread.sleep(2000);
        driver.navigate().back();
        Thread.sleep(1000);
        ...
        Thread.sleep(2000);
        String strUrl6 = "https://v2-test.zm1v1.com/zm-lessons/chuyi_chuer-huaxue.html";
        if(strUrl6.equals(driver.getCurrentUrl())){
            logger.debug("点击初一初二化学，跳转正确");
        }else{
            logger.debug("点击初一初二化学，跳转错误");
        }
    }
}
